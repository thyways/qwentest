...
class Qwen2VLAttention(nn.Module):
    ...
    def forward(
        ...
        torch.save({"key_ori":key_states},"/data1/bks/liurunze/qwen_final/utils/qkv_save.pt")
        ...
        if spec:  # spec decoding
            ...
            torch.save({"key":key_states},"/data1/bks/liurunze/qwen_final/utils/qkv_save.pt")
            new_cache = kv_cache
            ...
            if query_states.shape[1] == 1 and isinstance(graph_cache, RetrievalCache):
                if not graph_cache.init_graph: 
                    ...
                    graph_cache.update_graph_cache_retrieval(k_states=k_states,v_states=v_states,kv_cache=kv_cache,query_states=query_states,layer_idx=self.layer_idx)
                # else:
...
class Qwen2VLDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        torch.save({"hi":normed},"/data1/bks/liurunze/qwen_final/utils/qkv_save.pt")
        # Self-Attention 部分
