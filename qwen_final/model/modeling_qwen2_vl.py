...
class Qwen2VLFlashAttention2(Qwen2VLAttention):
    ...
    def forward(
        ...
        attn_output = self.o_proj(attn_output)
        torch.save({"attn":attn_output,"q":query_states,"v":value_states,"k":key_states},"/data1/bks/liurunze/qwentest/utils/qkv_save.pt")
        if not output_attentions:
            attn_weights = None
...
class Qwen2VLDecoderLayer(nn.Module):
    def __init__(self, config: Qwen2VLConfig, layer_idx: int):
        ...
        self.self_attn = Qwen2VLFlashAttention2(config=config, layer_idx=layer_idx)
    ...
    def forward(
        ...
        **kwargs,
        ...
        #torch.save({"output":outputs},"/data1/bks/liurunze/qwentest/utils/qkv_save.pt")
        return outputs
...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        #torch.save({"hidden":hidden_states},"/data1/bks/liurunze/qwentest/utils/qkv_save.pt")
        logits = self.lm_head(hidden_states)
        #torch.save({"logits":logits},"/data1/bks/liurunze/qwentest/utils/qkv_save.pt")
        loss = None
